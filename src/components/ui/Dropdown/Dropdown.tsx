...
export const DropdownButton = ({
  ...
  const buttonClass = cn(
    'flex items-center gap-2 p-1.5 text-sm font-medium text-[--muted-foreground] text-left bg-transparent w-full rounded',
    !isActive && !disabled,
    'hover:bg-white/5 hover:text-[--card-foreground]',
    isActive && !disabled && 'bg-white/10 text-[--card-foreground]',
